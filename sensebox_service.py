"""Service module for fetching and processing senseBox data from openSenseMap API."""
...
TEMPERATURE_SENSOR_PHENOMENON = "Temperatur"  # German name used in openSenseMap
...
def extract_temperature_value(box_data: Dict) -> Optional[Dict[str, Any]]:
    ...
    Returns:
        Dictionary with 'value' (float) and 'timestamp' (datetime), or None if not found.
    """
